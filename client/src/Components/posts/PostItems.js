...
const PostItems = ({auth, post:{_id, text, name, avatar, user, likes, comments, date}, likePost, unlikePost, deletePost}) => {
    return (
        <div>
            <div className="post bg-white p-1 my-1">
                ...
                <div>
                    ...
                    <Link to={`/post/${_id}`} className="btn btn-primary">
                        Discussion {comments.length>0 ? <span className='comment-count'>2</span> : null}
                    </Link>
